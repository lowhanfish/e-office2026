...
import { useCreateMasterSatker, useGetMasterInstansiOption } from '../hooks'
import { MasterSatkerItem } from "../types"
...
interface FormCreateProps {
    ...
    setItemForm: (key: keyof MasterSatkerItem, value: string | number) => void
    emptyForm: () => void
}

const FormAdd = ({ setClose, isEdit, form, setItemForm, emptyForm }: FormCreateProps) => {
