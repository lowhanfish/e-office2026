...
const FormAdd = ({ setClose, isEdit, form, setForm }: FormCreateProps) => {
    ...
    return (
        <div className='px-5 pb-2'>
            <div className='pt-1'>
                <BInput
                    title='Kode Ref Jenis Jabatan Umum (Id pada SIASN)'
                    placeholder='Kode Ref Jenis Jabatan Umum'
                    type='text'
                    value={form.kode}
                    onChange={(value) => {
            ...
            <div className='pt-1'>
                <BInput
                    title='Nama Ref Jenis Jabatan Umum'
                    placeholder='Nama Ref Jenis Jabatan Umum'
                    type='text'
                    value={form.nama}
                    onChange={(value) => {
