...
const FormAdd = ({ setClose, isEdit, form, setForm }: FormCreateProps) => {
    ...
    return (
        <div className='px-5 pb-2'>
            <div className='pt-1'>
                <BInput
                    title='Kode Ref ASN Jenis Jabatan (Id pada SIASN)'
                    placeholder='Kode Ref ASN Jenis Jabatan'
                    type='text'
                    value={form.kode}
                    onChange={(value) => {
            ...
            <div className='pt-1'>
                <BInput
                    title='Nama Ref ASN Jenis Jabatan'
                    placeholder='Nama Ref ASN Jenis Jabatan'
                    type='text'
                    value={form.nama}
                    onChange={(value) => {
