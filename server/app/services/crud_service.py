"""Reusable CRUD operations shared by multiple resources."""
...
# Gunakan class deklaratif SQLAlchemy sebagai static type. ``Base`` aplikasi
# dibuat secara dinamis oleh database factory sehingga tidak valid sebagai
# type expression bagi Pyright/Pylance.
